...
import { ai, availableFunctions, SYSTEM_PROMPT, startGeminiChat } from '../services/geminiService.js';
...
export class ChatController {
  ...
  private generateSuggestions(data: any, functionName: string): string[] {
    const suggestions = [];
